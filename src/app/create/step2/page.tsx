  ...
  useEffect(() => {
    ...
    if (contractType === "전세" || contractType === "월세") {
      setArticles([
        ...
        "제2조 (존속기간)\n임대인은 위 부동산을 임대차 목적대로 사용 수익할 수 있는 상태로 하여 계약 시작일까지 임차인에게 인도하며, 임대차기간은 인도일로부터 계약 만료일까지로 한다.",
        ...
        "제9조 (중개대상물확인.설명서 교부 등)\n개업공인중개사는 중개대상물 확인.설명서를 작성하고 업무보증관계증서(공제증서 등) 사본을 첨부하여 계약일까지 거래당사자 쌍방에게 교부한다.",
      ]);
    }
  }, [router]);
